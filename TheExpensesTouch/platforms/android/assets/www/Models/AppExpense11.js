...
$("#PrepareMyTravels-layout").ready(function () {
    ...
    function insertExpensetransaction(travelid, date, description, amount, expensetypeid, currencytype, img)
    {
      ...
      //  params.expensetypeid = expensetypeid;
        ...
        params.img = img;
        params.ExpenseId = expensetypeid;
        ...
        var fail = function(error) {
            ...
            navigator.notification.alert("oops, Some thing Bad happened...", alertDismissed, 'Expense', 'Done');
            window.location = "#viewExpensesOfTravelByDate?TID=" + travelid;
        };
        ...
        ft.upload(img, encodeURI("https://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/UpdateMultipartExpensesbyExpensesId"), win, fail, options);
    }
...
//            alert("An error has occurred: Code = " + error.code);
        ...
        var ft = new FileTransfer();
        ft.upload(fileURI, encodeURI("https://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/UpdateMultipartExpensesbyExpensesId"), win, fail, options);
    }
