...
function getuser(email, password) {
    ...
    $.ajax({
        ...
        url: "http://theexpensestouch.com/ExpensesTouchMobile.asmx/GetLogin",
...
$("#PrepareMyTravels-layout").ready(function () {
    ...
    function insertTravelstrans(travelname, datefrom, dateto, descriptions) {
        ...
        $.get("http://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/InsertTravel?TravelName=" + travelname + "&DateFrom=" + datefrom + "&DateTo=" + dateto + "&Description=" + descriptions + "&UserId=" + userid + "&CountryId=" + countryid, function (response, status) {
    ...
    function getTravelTrans() {
        ...
        console.log(window.localStorage["CountryId"]);
            $.ajax({
                ...
                url: "http://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/GetAllTravelByUserId",
    ...
    function viewTravelById(id) {
        ...
        $.get("http://theexpensestouch.com/ExpensesTouchMobile.asmx/GetExpensesAmountByTravelId?TravelId=" + id, function (response, status) {
    ...
    function edittravelexpens(expenseid) {
        ...
        $.get("http://theexpensestouch.com/ExpensesTouchMobile.asmx/GetExpensesByExpensesId?ExpensesId=" + expenseid, function (response, status) {
            console.log(response);// +
    ...
    function getExpensebytravelid(tid)
    {
        ...
        console.log(data);
        $.get("http://theexpensestouch.com/ExpensesTouchMobile.asmx/GetExpensesByTravelId?TravelId=" + tid, function (response, status)
        {
            kendoMobileApp.pane.loader.hide();
            console.log(response);// +
            //  console.log("\nStatus: " + status);
    ...
    function getExpenseType() {
        ...
        $.get("http://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/GetAllExpenseTypes?OrgId=" + orgid, function (response, status) {
    ...
    function UpadateExpensetransaction(expenseid, travelid, date, descr, amount, expenseTypeid, currency, image) {
     //   document.getElementById("btn-update").style.pointerEvents = "none";
        ...
        $.post("http://theexpensestouch.com/ExpensesTouchMobile.asmx/UpdateExpensesbyExpensesId", data1, function (data, status) {
            ///getElementById('btn-update').removeAttribute("style");
...
// function mysubmissionpulltorefresh(e) {
    ...
    function GetAllTravelByUserIdS() {
        var userid = window.localStorage["UserId"];
        var countryid = window.localStorage["CountryId"];
        var url="http://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/Getsubmitedextravel?UserId=" + userid + "&CountryId=" + countryid;
        //var data = {
        //    TravelId: tid
        //};
        //alert(data);
       ...
       $.get("http://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/Getsubmitedextravel?UserId=" + userid + "&CountryId=" + countryid, function (response, status) {
            console.log(response);// +
            //  console.log("\nStatus: " + status);
            // var result = JSON.parse(response);
            kendoMobileApp.pane.loader.hide();
    ...
    function onPhotoDataSuccess(base64Img) {
        ...
        console.log(base64Img);
        var cameraImage;
        var   cameraImageEdit = document.getElementById('Img');
        var edit = window.localStorage["from"];//, "Edit")
      //  alert(edit);
        //if (edit == "Edit") {
        //    alert("in");
    ...
    function GetAllTravelByUserIdForHomePage() {
        kendoMobileApp.pane.loader.show();
        var userid = window.localStorage["UserId"];
        $.get("http://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/GetPendingApprovals?UserId=" + userid + "&countryid=" + window.localStorage["CountryId"], function (response, status) {
            kendoMobileApp.pane.loader.hide();
            console.log(response);
            var lengt = response.length;
...
// country loading page 
    ...
    function selectcountry(userid) {
        console.log(userid);
        $.get("http://theexpensestouch.com/NewExpenseCountry_Orgwise.asmx/GetAllCountryImagesByUserId?UserId=" + userid, function (response, status) {
           // alert(status);
           console.log("test");
           $(".top-grid1").html('');
