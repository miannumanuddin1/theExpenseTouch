...
function CapturePhotoUpload() {
    ...
    var options = {
        quality: 80, targetWidth: 500,targeHeight: 500,correctOrientation: true, destinationType: Camera.DestinationType.DATA_URL, encodingType: Camera.EncodingType.PNG, sourceType: Camera.PictureSourceType.CAMERA, saveToPhotoAlbum: false, popoverOptions: popover
    };
...
function CapturePhotoEdit() {
    ...
    var popover = new CameraPopoverOptions(300, 300, 100, 100, Camera.PopoverArrowDirection.ARROW_ANY);
    var options = {
        quality: 80, targetWidth: 500, targetHeight: 500, correctOrientation: true, destinationType: Camera.DestinationType.DATA_URL, encodingType: Camera.EncodingType.PNG, sourceType: Camera.PictureSourceType.CAMERA, saveToPhotoAlbum: false, popoverOptions: popover
    };
