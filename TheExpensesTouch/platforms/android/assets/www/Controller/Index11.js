                ...
                if (date == "") {
                    ...
                    if (commentRequired == "true") {
                        if (descr == "") {
                            ...
                            insertExpensetransaction(travelid, date, descr, amount, expenseid, currency, im);
                        }
                    } else {
                        insertExpensetransaction(travelid, date, descr, amount, expenseid, currency, im);
                    }
...
function CapturePhotoUpload() {
    ...
    var options = {
        quality: 50, targetWidth: 500,targeHeight: 500,correctOrientation: true, destinationType: Camera.DestinationType.FILE_URI, encodingType: Camera.EncodingType.PNG, sourceType: Camera.PictureSourceType.CAMERA, saveToPhotoAlbum: false, popoverOptions: popover
    };
...
function CapturePhotoEdit() {
    ...
    var popover = new CameraPopoverOptions(300, 300, 100, 100, Camera.PopoverArrowDirection.ARROW_ANY);
    var options = {
        quality: 50, targetWidth: 500, targetHeight: 500, correctOrientation: true, destinationType: Camera.DestinationType.FILE_URI, encodingType: Camera.EncodingType.PNG, sourceType: Camera.PictureSourceType.CAMERA, saveToPhotoAlbum: false, popoverOptions: popover
    };
                    ...
                    if (commentRequired == "true") {
                        if (descr == "") {
                         ...
                         kendoMobileApp.pane.loader.hide();
                            ...
                            UpadateExpensetransaction(expenseid, travelid, date, descr, amount, expenseTypeid, currency, im);
                        }
                    } else {
                        UpadateExpensetransaction(expenseid, travelid, date, descr, amount, expenseTypeid, currency, im);
                    }
